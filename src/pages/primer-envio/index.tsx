...
import { banner, features, featuresTwo, commercial } from '@data/primer-envio';
		...
		<Layout>
			...
			<div className='container'>
				...
				<p className='containerDescription'>
					...
					<strong>empresas de envíos en Colombia</strong> con su calificación y
					costo del servicio.
				</p>
				<Ally title={false} />
				{/* section  */}
					...
					<div className={styles.items}>
						<ul className={styles.icon}>
							...
							<li>
								...
								Recuerda que también puedes dejar los envíos en la oficina de la
								transportadora que seleccionaste con los documentos necesarios.
							</li>
							<li>
				...
				<div className={styles.video}>
					<Image src='/images/video.png' alt='video' layout='fill' />
				</div>
				<div className={styles.margin}>
				...
				<p className='containerDescription'>
					...
					bancaria, en la cual te enviaremos los desembolsos de los recaudos en
					las fechas específicas de corte.
				</p>
				<p className='containerDescription'>
				...
				<div className={styles.Features}>
					<div className={styles.items}>
						<ul className={styles.icon}>
							<li>
								El pago corresponde a los envíos entregados a tu cliente final,
								es decir, el “Destinatario” así:
							</li>
							...
							<li>
								...
								transferencia del total de recaudo, no es un cobro que se genere
								por cada envío.
								<br />
						...
						<ul className={styles.icon}>
							<li>
								En un <strong>envío con recaudo</strong> tu cliente puede pagar
								al momento de recibir el paquete, producto más envío o solo
								producto.
							</li>
							<li>
								Un <strong>envío sin recaudo,</strong> es cuando el cliente te
								genera de manera anticipada el pago del producto más el envío.
								Para que puedas generar el despacho de tu paquete, es necesario
								que realices una recarga del saldo tipo "prepago" en nuestra
								plataforma, de allí se descontará el costo del envío y la
								transportadora le entregará el producto a tu destinatario sin
								generar cobro adicional.
							</li>
						</ul>
						...
						<ul className={styles.icon}>
							<li>
								...
								es por esto que se complica un poco manejar un cuadro de tarifas
								específico; sin embargo, al cotizar tu envío podrás comparar y
								elegir entre las diferentes empresas transportadoras de envíos
						...
						<ul className={styles.icon}>
							<li>
								El porcentaje del recaudo varía según la transportadora, la cual
								se encuentra entre el 4% y 4.3% o tarifa mínima entre $4.900 y
								$5.700, estos costos se encuentran incluidos en la cotización de
								nuestra plataforma. La tarifa que te indica el sistema ya tiene
								incluido flete y porcentaje de recaudo,{' '}
								<strong>no necesitas pagar un valor adicional.</strong> <br />
								Podrás consultar la información sobre los recaudos liquidados a
								través de nuestro Centro de Novedades ingresando a:
								<a
						...
						<ul className={styles.icon}>
							<li>
								<strong>
									Indicar el valor declarado o valor de tu mercancía es esencial
									en caso de pérdida
								</strong>{' '}
								para que la transportadora lo pueda reconocer, así que recuerda
								que este aspecto hace parte del{' '}
								<strong>proceso de logística de envíos.</strong>
								Para iniciar un proceso en caso de pérdida, se debe soportar con
								el valor de factura de compra del producto, el cual certifica el
								valor del producto. Serán 15 días hábiles a partir del momento
								en el que se confirme el{' '}
						...
						<ul className={styles.icon}>
							<li>
								Puedes ingresar a nuestro <strong>Centro de Novedades,</strong>{' '}
								allí podrás reportar y gestionar cualquier inconveniente
								operacional sobre tus envíos o a través de nuestro chat vía
								WhatsApp, opción 4. En ningún momento es necesario que te
								contactes con la transportadora, ya que nosotros centralizamos
								la comunicación directa con ellos para una solución más rápida y
								efectiva.
							</li>
							<div className={styles.videoItems}>
								<Image src='/images/video.png' alt='video' layout='fill' />
