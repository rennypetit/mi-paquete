export const data = {
	...
	content: `
	<div class="postBannerImage"><img src="/images/blog/detras-de-un-envio.jpg" alt="detras-de-un-envio" /></div>

	<p><strong>Lo que ocurre detrás de un envío: Por Tempo Express y Mipaquete.com</strong></p>

	<p>¿Te has preguntado cuál es el proceso que debe pasar un envío para llegar hasta la puerta de tu casa? Para aclarar dudas tuvimos la oportunidad de conversar con Angélica Rodríguez Directora Comercial y Jessica Ahumada Jefe de oficina de Cartagena de Tempo Express y nos contaron acerca de su proceso de logística de envíos basado en un plan de calidad para la satisfacción del cliente enfocado a ser los líderes en mensajería y logística en el país, afianzando la cobertura a nivel nacional y fortaleciendo e innovando en nuevos servicios.</p>

	<p>Todo lo anterior se resume en una frase…¡Más calidad igual a clientes felices!</p>
	<p>A continuación mencionaremos cada uno de los pasos ejecutados por Tempo Express para que tu envío llegue sano y salvo a su destino</p>
	...
	<p>Sin embargo, ¿Qué es una novedad? Son los envíos que por algún motivo no lograron ser entregados al destinatario, a partir de estas Tempo Express realiza una labor de contacto telefónico con las devoluciones y finalmente se realizan los reenvíos respectivos para convertirlos a envíos efectivos.</p>

	<p>Por último, Tempo Express realiza un informe final al cliente de los productos entregados de manera efectiva o devoluciones realizadas para facilitar el seguimiento de la logística de los envíos, no obstante recordemos que cada uno de los procesos de calidad están certificados con ISO9001 para ofrecer el mejor servicio</p>
