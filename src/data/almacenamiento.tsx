...
export const slider = [
	...
	},
	{
		...
		imageThumbnail: '',
		alt: 'slider',
		title: '2¿Cómo puedes almacenar los productos de',
		titleStrong: 'tu tienda con nosotros?',
		description:
			'<p>2Hemos pensado en <strong>todo tipo de empresas,</strong> por eso contamos con diferentes planes para el <strong>almacenamiento de productos desde 100 hasta más de 5.000 unidades,</strong> para que elijas la que más se adapte a las necesidades de tu ecommerce, mientras nos encargamos de almacenar, realizar inventarios y enviar los productos que haz vendido.</p>',
		button: {
			title: 'CONOCE MÁS',
			url: '#',
		},
	},
	{
		...
		imageThumbnail: '',
		alt: 'slider',
		title: '3¿Cómo puedes almacenar los productos de',
		titleStrong: 'tu tienda con nosotros?',
		description:
			'<p>3Hemos pensado en <strong>todo tipo de empresas,</strong> por eso contamos con diferentes planes para el <strong>almacenamiento de productos desde 100 hasta más de 5.000 unidades,</strong> para que elijas la que más se adapte a las necesidades de tu ecommerce, mientras nos encargamos de almacenar, realizar inventarios y enviar los productos que haz vendido.</p>',
		button: {
			title: 'CONOCE MÁS',
			url: '#',
		},
	},
	{
		...
		imageThumbnail: '',
		alt: 'slider',
		title: '4¿Cómo puedes almacenar los productos de',
		titleStrong: 'tu tienda con nosotros?',
		description:
			'<p>4Hemos pensado en <strong>todo tipo de empresas,</strong> por eso contamos con diferentes planes para el <strong>almacenamiento de productos desde 100 hasta más de 5.000 unidades,</strong> para que elijas la que más se adapte a las necesidades de tu ecommerce, mientras nos encargamos de almacenar, realizar inventarios y enviar los productos que haz vendido.</p>',
		button: {
			title: 'CONOCE MÁS',
			url: '#',
		},
	},
	{
		...
		imageThumbnail: '',
		alt: 'slider',
		title: '5¿Cómo puedes almacenar los productos de',
		titleStrong: 'tu tienda con nosotros?',
		description:
			'<p>5Hemos pensado en <strong>todo tipo de empresas,</strong> por eso contamos con diferentes planes para el <strong>almacenamiento de productos desde 100 hasta más de 5.000 unidades,</strong> para que elijas la que más se adapte a las necesidades de tu ecommerce, mientras nos encargamos de almacenar, realizar inventarios y enviar los productos que haz vendido.</p>',
		button: {
			title: 'CONOCE MÁS',
			url: '#',
		},
	},
	{
		...
		imageThumbnail: '',
		alt: 'slider',
		title: '6¿Cómo puedes almacenar los productos de',
		titleStrong: 'tu tienda con nosotros?',
		description:
			'<p>6Hemos pensado en <strong>todo tipo de empresas,</strong> por eso contamos con diferentes planes para el <strong>almacenamiento de productos desde 100 hasta más de 5.000 unidades,</strong> para que elijas la que más se adapte a las necesidades de tu ecommerce, mientras nos encargamos de almacenar, realizar inventarios y enviar los productos que haz vendido.</p>',
		button: {
			title: 'CONOCE MÁS',
			url: '#',
		},
...
export const form = {
	...
	titleForm: 'Recibe asesoría personalizada para',
	titleFormSpan: 'adquirir este servicio',
	formDescription:
		'Al dejar tus datos nuestro equipo te contactará para asesorarte con soluciones que se adapten a tu e-commerce.',
